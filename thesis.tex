...
\input{Thesis/userpackages}        % Пакеты для специфических пользовательских задач
...
\input{Thesis/userstyles}          % Стили для специфических пользовательских задач
...
\include{Thesis/title}           % Титульный лист
\include{Thesis/contents}        % Оглавление
\include{Thesis/introduction}    % Введение
\include{Thesis/part1_overview}    % Первая глава
\include{Thesis/part2_method}    % Вторая глава
\include{Thesis/part3_practice}   % Третья глава
%\include{Thesis/conclusion}      % Заключение
